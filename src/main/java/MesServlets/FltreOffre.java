 ...
 * @author minfo
 */
@WebServlet(name = "FltreOffre", urlPatterns = {"/FltreOffre"})
public class FltreOffre extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       OffreDAO offreDAO = new OffreDAO();
        ...
        String recruteur = request.getParameter("recruteur");

        // Appel de la méthode de recherche
        List<Offres> offres = offreDAO.rechercherOffres(titre, competences, recruteur);
